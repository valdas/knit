...
#Prints up to 256 strings. Stops when it meets an empty string. If any string
#begins with a blank space, indent that string with a 8 blank characters.

#This function is useful for printing large text messages without fussing with
#end of line continuations, controlling for tabs, etc.
